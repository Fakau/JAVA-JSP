...
<%
    ...
    VacationDao met = new VacationDao();
	
    vacations= met.allVacation();
	if(request.getParameter("id")!=null){
		for(Vacation annn : vacations){
...
<!-- hhkl -->
   ...
   <div class="container">
     ...
     <!-- form ajouter -->
       <div class="col">
         <h1>Ajouter une vacation</h1>
         <hr>
				<form action="<%=request.getContextPath()%>/vacation" method="POST">
       ...
       <div class="coll">
        ...
        <!--  form recherche -->
        <div class="fr">
         <form class="form-inline" action="<%=request.getContextPath()%>/vacation" method="POST">
			<div class="form-group">
	            ...
	            <table class="table table-bordered table-hover">
	              <tr>
	                 ...
	                 <td>Action</td>
	                    ...
	                    <%
	                      Vacation yess=(Vacation)request.getAttribute("seach");
			              int count = 0;
					      VacationDao metier=new VacationDao();
			              List<Vacation> ans=metier.allVacation();
			              for(Vacation annee : ans){
	                     %>
         ...
         <div class="modal-content">
            ...
            <div class="modal-body">
				<form class="form-horizontal form-label-left"
						action="<%=request.getContextPath()%>/vacation"
...
<input type="hidden" id="id" name="id" value="<%=request.getParameter("id")!=null?request.getParameter("id"):"" %>" />
						...
						<div class="form-group col-md-12 col-sm-12 col-xs-12">
							...
							<input type="text" name="codem" id="codem" value="<%=selected!=null?selected.getCode():"" %>" required="required" class="form-control">
						</div>
		...
		$(document).ready(function () {
			if($("#id").val()!==''){
				if($("#operation").val()==="UPDATE"){
					...
					$("#titre").text("Supprimer une vacation");
				}
